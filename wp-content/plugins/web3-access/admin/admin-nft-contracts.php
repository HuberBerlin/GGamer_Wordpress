                ...
                <div class="metapress-admin-settings metapress-border-box metapress-width-600">
                  <div class="metapress-grid metapress-setting">
                    ...
                    <div class="metapress-setting-content metapress-align-right">
                     <input class="regular-text" name="metapress_opensea_api_key" type="text" value="<?php echo esc_html( $metapress_opensea_api_key ); ?>"  />
                    </div>
                  </div>
                  <div class="metapress-grid metapress-setting">
                    <div class="metapress-setting-title">
                    ...
                    <?php if( ! empty($metapress_nft_contract_list) ) {
                        ...
                        <div class="metapress-admin-settings metapress-border-box live-token">
                            <div class="metapress-grid metapress-wallet metapress-setting">
                             ...
                             <div class="metapress-grid metapress-wallet metapress-setting">
                               <div class="metapress-setting-title">
                                 <?php _e('ERC Type', $wp_metapress_textdomain); ?>
                               </div>
                               <div class="metapress-setting-content">
                                 <select name="metapress_nft_contract_list[<?php echo esc_attr( $key ); ?>][token_type]">
                                   <option value="erc20" <?php selected($token['token_type'], 'erc20'); ?>><?php _e('ERC-20', $wp_metapress_textdomain); ?></option>
                                   <option value="erc721" <?php selected($token['token_type'], 'erc721'); ?>><?php _e('ERC-721', $wp_metapress_textdomain); ?></option>
                                   <option value="erc1155" <?php selected($token['token_type'], 'erc1155'); ?>><?php _e('ERC-1155', $wp_metapress_textdomain); ?></option>
                                 </select>
                               </div>
                             </div>
