                        ...
                        <div class="metapress-admin-settings metapress-border-box live-token">
                            ...
                            <div class="metapress-grid metapress-wallet metapress-setting">
                             ...
                             <div class="metapress-grid metapress-wallet metapress-setting">
                               ...
                               <div class="metapress-setting-content">
                                 <input class="regular-text token-usd-price" name="metapress_custom_tokens_list[<?php echo esc_attr( $key ); ?>][usd_price]" type="number" min="0" step="0.01" value="<?php echo esc_attr( $token['usd_price'] ); ?>" /><br><br>
