    ...
    <div class="metapress-plugin-settings">
        <form method="post" action="options.php">
              ...
              <div class="metapress-admin-settings metapress-border-box metapress-width-600">
                <div class="metapress-grid metapress-setting">
                  ...
                  <div class="metapress-setting-content metapress-align-right">
                    ...
                    <p><?php _e('Enabling this option will lock your entire website. Visitors will need to either purchase one of your MetaProducts or verify they own an NFT to access your website content.', $wp_metapress_textdomain); ?></p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="metapress-admin-section metapress-border-box">
                ...
                <p class="metapress-admin-notice"><?php _e('Set which MetaProducts are required to access website content. Visitors will only need to purchase or verify 1 of these products.', $wp_metapress_textdomain); ?></p>
              <div class="metapress-admin-settings metapress-border-box metapress-width-600">
                <div class="metapress-grid metapress-setting">
                  <div class="metapress-setting-title">
